...
if("TRUE" STREQUAL "TRUE")
  set(robot_navigation_SOURCE_PREFIX /home/csrobot/Desktop/NERVE_CENTER/ROS_navigation_localization/catkin_ws/src/robot_navigation)
  set(robot_navigation_DEVEL_PREFIX /home/csrobot/Desktop/NERVE_CENTER/ROS_navigation_localization/catkin_ws/devel/.private/robot_navigation)
  ...
  set(robot_navigation_INSTALL_PREFIX /home/csrobot/Desktop/NERVE_CENTER/ROS_navigation_localization/catkin_ws/install)
...
if(NOT "/home/csrobot/Desktop/NERVE_CENTER/ROS_navigation_localization/catkin_ws/devel/.private/robot_navigation/include " STREQUAL " ")
  set(robot_navigation_INCLUDE_DIRS "")
  set(_include_dirs "/home/csrobot/Desktop/NERVE_CENTER/ROS_navigation_localization/catkin_ws/devel/.private/robot_navigation/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Ronaldson Bellande <ronaldsonbellande@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/csrobot/Desktop/NERVE_CENTER/ROS_navigation_localization/catkin_ws/src/robot_navigation/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/csrobot/Desktop/NERVE_CENTER/ROS_navigation_localization/catkin_ws/devel/.private/robot_navigation/lib;/home/csrobot/Desktop/NERVE_CENTER/ROS_navigation_localization/catkin_ws/devel/lib;/opt/ros/melodic/lib)
...
set(depends "roscpp;rospy;std_msgs;std_srvs;tf2;tf2_ros;geometry_msgs;message_runtime;move_base_msgs;actionlib;gazebo_msgs;tuw_voronoi_graph;tuw_multi_robot_msgs;cv_bridge;dynamic_reconfigure;nav_msgs")
