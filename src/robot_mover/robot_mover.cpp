...
private:
  ...
  public:
  robot_mover() {
    robot_subscriber = node_handle.subscribe("goal",1, &robot_mover::move_robot_callback, this);
  ...
  void move_robot_callback(robot_navigation::Goal goal_msg) {
...
int main(int argc, char **argv) {
  ...
  ros::init(argc, argv, "robot_mover_publisher");
  robot_mover robot_mover_obj;
